      ...
      <div className='location'>
        ...
        <div className='host-and-rating'>
          <div className='host'>
            ...
            <img className='host-picture' src={item.host.picture} alt={`Portrait de ${item.host.name}`} />
          </div>
          <Rating rating={item.rating}/>
        </div>
      </div>
      <div className='description-equipment'>
      <CollapseMenu collapseData={description} customClass={'location-collapse'}/>
      <CollapseMenu collapseData={equipment} customClass={'location-collapse'}/>
      </div>
    </div>
  )
}
